...
When writing code in HRG projects, it is important to follow the standards and guidelines set below for each specific programming language. This allows for clean, concise, and descriptive source code within HRG.

## General Comments
When writing any sort of comment or note for developers, HRG emphasizes "self-documenting" code, where clear naming and structure reduce the need for comments.

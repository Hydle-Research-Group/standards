...
When using the Git version control system in HRG projects, it is important to follow the standards and guidelines set below. This allows for clean, concise, and descriptive Git usage within HRG.
